...
const About = () => {
    ...
    return (
        <div
            id="about"
            className="flex flex-col items-center justify-center h-screen bg-background text-foreground px-6 mt-16"
        >
            <div className="max-w-2xl text-left space-y-4 px-4 sm:px-6 md:px-8 lg:px-10">
                <h1 className="text-4xl sm:text-5xl font-bold">
                    Hi, I&apos;m David.
                </h1>
                <p className="text-base sm:text-lg md:text-xl leading-relaxed py-6 sm:py-8">
